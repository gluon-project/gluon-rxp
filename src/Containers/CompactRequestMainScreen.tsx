...
import { CallToAction, RequestDetails, ScrollView } from '../Components'
...
class CompactRequestMasterScreen extends RX.Component<Props, null> {
  render() {
    return (
...
export default connect(mapStateToProps, mapDispatchToProps)(CompactRequestMasterScreen)
