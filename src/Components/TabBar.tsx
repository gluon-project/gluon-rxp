    ...
    return (
      ...
      >
        ...
        <TabBarButton
          ...
          onPress={() => this.props.navigate('FeedTab')}
          selected={tabRouteName === 'FeedTab'}
        />
        <TabBarButton
          type={type}
          title='Wallet'
        ...
        <TabBarButton
          type={type}
          title='Send'
          iconType={TabBarButton.icon.Send}
        ...
        <TabBarButton
          type={type}
          title='Request'
          iconType={TabBarButton.icon.Request}
          onPress={() => this.props.navigate('RequestTab')}
          selected={tabRouteName === 'RequestTab'}
        />
        <TabBarButton
          type={type}
          title='About'
